        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Connecting students with verified internship opportunities
              worldwide.
            </p>
            {/* Social Media */}
            <div className="flex gap-3">
              <a
                href="#"
                className="w-9 h-9 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-[#2563EB] transition"
              >
                <Facebook size={18} />
              </a>
              <a
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#careers" className="hover:text-[#10B981] transition">
                  Careers
                </a>
              </li>
              <li>
                <a href="#blog" className="hover:text-[#10B981] transition">
                  Blog
                </a>
              </li>
              <li>
                <a href="#press" className="hover:text-[#10B981] transition">
                  Press
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="#help" className="hover:text-[#10B981] transition">
                  Help Center
                </a>
              </li>
              <li>
