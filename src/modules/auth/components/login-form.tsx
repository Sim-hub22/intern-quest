    ...
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-[#F8FAFC] text-gray-500">
            Or continue with
          </span>
        </div>
      </div>
      ...
      <button
        ...
        className="flex items-center w-full justify-center gap-2 px-4 py-3 border border-gray-200 rounded-lg hover:bg-white transition"
      >
